...
--
-- Host: localhost
-- Generation Time: Apr 07, 2025 at 12:46 AM
...
CREATE TABLE `vh_candidate` (
  ...
  `extra_act` varchar(100) NOT NULL,
...
INSERT INTO `vh_candidate` (`id`, `name`, `gender`, `dob`, `mobile`, `email`, `username`, `password`, `address`, `city`, `postal_code`, `sslc_school`, `sslc_mark`, `hsc_school`, `hsc_mark`, `father_name`, `father_occupation`, `father_jobtype`, `father_job_location`, `father_annual_income`, `mother_name`, `mother_occupation`, `mother_jobtype`, `mother_job_location`, `mother_annual_income`, `resume`, `photo`, `register_date`, `question`, `program`, `status`, `interests`, `extra_act`, `sports`) VALUES
(1, 'Harish', 'Male', '10.12.1994', 7305569774, 'bgeduscanner@gmail.com', 'harish', '123456', '45,SG Nagar', 'Salem', '635421', 'BS', 91, 'BS', 92, 'Raj', 'Tailor', '', 'Salem', 200000, 'Vijaya', '', '', '', 0, 'R1resume_001.docx', '', '30-12-2023', '13,17,14,5,4', '15', 0, '', '', ''),
...
--
-- Table structure for table `vh_motivation`
--

CREATE TABLE `vh_motivation` (
  `id` int(11) NOT NULL,
  `message` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `vh_motivation`
--

INSERT INTO `vh_motivation` (`id`, `message`) VALUES
(1, 'Dont limit yourself'),
(2, 'Opportunities dont happen, you create them'),
(3, 'It is never too late to be what you might have been'),
(4, 'Happiness depends upon ourselves'),
(5, 'Life shrinks or expands in proportion to ones courage'),
(6, 'Nothing will work unless you do'),
(7, 'Keep your face always toward the sunshine');
